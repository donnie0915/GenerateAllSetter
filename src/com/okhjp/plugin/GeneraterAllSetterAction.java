...
public class GeneraterAllSetterAction extends AnAction {
        ...
        application.runWriteAction(new Runnable() {
            public void run() {
                ...
                for (String arg : setMethods.keySet()) {
                    ...
                    final String charSequence = blankSpace + className + "." + setMethods.get(arg) + "();\n";

                    new WriteCommandAction(project) {
                        @Override
                        protected void run(Result result) throws Throwable {
                            document.insertString(lineStartOffset, charSequence);
                        }
                    }.execute();
